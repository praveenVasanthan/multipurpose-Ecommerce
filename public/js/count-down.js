...
(function () {
    ...
    CountDown.prototype.updateCountDown = function (bool) {
        ...
        // Luôn hiển thị days ở định dạng 00
        ...
        if (
            ...
            this.hours.parentElement.style.display = ""; // Ensure it's visible if hours > 0
        }
        ...
        if (
            ...
            this.mins.parentElement.style.display = ""; // Ensure it's visible if mins > 0
        }
